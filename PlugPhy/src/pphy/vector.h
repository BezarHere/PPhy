...
namespace pphy
{
	...
	using Vector2 = BaseVector2Template<real_t>;
	using Vector3 = BaseVector3Template<real_t>;
	using Vector4 = BaseVector4Template<real_t>;
...
namespace std
{
	...
	template <typename _T, typename _R>
	inline std::ostream &operator<<(std::ostream &out, const pphy::BaseVector2Template<_T, _R> &vec)
	{
		return out << '(' << vec.x << ", " << vec.y << ')';
	}

	template <typename _T>
	inline std::ostream &operator<<(std::ostream &out, const pphy::BaseVector3Template<_T> &vec)
	{
		return out << '(' << vec.x << ", " << vec.y << ", " << vec.z << ')';
	}

	template <typename _T>
	inline std::ostream &operator<<(std::ostream &out, const pphy::BaseVector4Template<_T> &vec)
	{
